module Types
  class QueryType < Types::BaseObject
    ...
    field :current_user_lenta, [Types::PostType], 'Returns selected user lenta', null: true

    def current_user_lenta
      Queries::PostsQuery.lenta(context[:current_user].id)
    end
    ...
    def chat_rooms
      context[:current_user].room_members.map(&:room)
    end
